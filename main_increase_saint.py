...
thisFilename = 'citeseer_saint' # This is the general name of all related files
...
for args in [
        {'batch_size': 500, 'epochs': 500, 'opt': 'adam', 'opt_scheduler': 'none', 'opt_restart': 0, 'weight_decay': 5e-3, 'lr': 0.001},
    ]:
...
for args2 in [
        {'batch_size': 500, 'epochs': n_epochs_per_n, 'opt': 'adam', 'opt_scheduler': 'none', 'opt_restart': 0, 'weight_decay': 5e-3, 'lr': 0.001},
    ]:
...
for i in range(n_increases+1):
    ...
    loader = GraphSAINTNodeSampler(sampledData, batch_size=args.batch_size, shuffle=False)
    ...
    another_loader = GraphSAINTNodeSampler(dataset_transf[0], batch_size=args.batch_size, shuffle=False)
