...
thisFilename = 'pubmed_node_3000' # This is the general name of all related files
...
for args in [
        {'batch_size': 256, 'epochs': 100, 'opt': 'adam', 'opt_scheduler': 'none', 'opt_restart': 0, 'weight_decay': 5e-3, 'lr': 0.0001},
    ]:
...
for args2 in [
        {'batch_size': 256, 'epochs': n_epochs_per_n, 'opt': 'adam', 'opt_scheduler': 'none', 'opt_restart': 0, 'weight_decay': 5e-3, 'lr': 0.0001},
    ]:
