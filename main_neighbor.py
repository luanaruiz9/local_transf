...
for model in modelList:
    ...
    # Trasferability
    another_test_loader = DataLoader(dataset_transf[0], num_neighbors=[30]*(len(F)-1), batch_size=args.batch_size, input_nodes = dataset_transf[0]['test_mask'], shuffle=False)
